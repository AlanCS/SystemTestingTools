...
namespace SystemTestingTools
{
    ...
    {
        internal static string GlobalSession = "Global";
        internal static string sessionHeaderName = "SystemTestingTools_Session";
        public static string responseHeaderName = "SystemTestingToolsStub";
        ...
        public static InterceptionConfiguration GlobalConfiguration = null;
        ...
        internal static void AddResponseHeader(string reason)
        {
            ...
            httpContextAccessor.HttpContext.Response.Headers.Append(responseHeaderName, reason);
        }        
        ...
        internal static class TestStubs
        {
            ...
            {
                {  GlobalSession, new List<StubEndpoint>() }
            };
